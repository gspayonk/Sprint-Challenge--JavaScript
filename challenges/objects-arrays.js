...
lowPopulationAnimals = zooAnimals.filter(function(lowPopulation) {
    return lowPopulation.population < 5;
})
...
populationTotal = zooAnimals.reduce((zoos, animal) => {
    return zoos += animal.population
}, 0)
