...
1. Describe the biggest difference between `.forEach` & `.map`.
    ...
    The biggest difference between `.forEach` & `.map` is that map iterates over an array and returns the result whereas forEach only iterates over the array.

2. What is the difference between a function and a method?
    A method is a associated with an object, whereas a function is independent.

3. What is closure?
    A closure gives you access to an outer function's scope from an inner function.

4. Describe the four rules of the 'this' keyword.
    - Window/Global Object Binding: when in global scope, the value of "this" will be in the window/console Object.
